...
- **role** (query, 可选): 角色筛选（0-普通用户, 1-版主, 2-管理员）
- **status** (query, 可选): 状态筛选（0-禁用, 1-启用）
...
- **status** (query, 可选): 状态筛选（0-删除, 1-正常, 2-置顶）
